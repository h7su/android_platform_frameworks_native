 ...
 * Available since API level 29.
 */
typedef void (*ASurfaceTransaction_OnComplete)(void* _Null_unspecified context, ASurfaceTransactionStats* _Nonnull stats)
                                               __INTRODUCED_IN(29);
 ...
 * Available since API level 31.
 */
typedef void (*ASurfaceTransaction_OnCommit)(void* _Null_unspecified context, ASurfaceTransactionStats* _Nonnull stats)
                                               __INTRODUCED_IN(31);
 ...
 * Available since API level 29.
 */
void ASurfaceTransaction_setOnComplete(ASurfaceTransaction* _Nonnull transaction, void* _Null_unspecified context,
                                       ASurfaceTransaction_OnComplete _Nonnull func) __INTRODUCED_IN(29);
 ...
 * Available since API level 31.
 */
void ASurfaceTransaction_setOnCommit(ASurfaceTransaction* _Nonnull transaction, void* _Null_unspecified context,
                                    ASurfaceTransaction_OnCommit _Nonnull func) __INTRODUCED_IN(31);
...
void ASurfaceTransaction_setGeometry(ASurfaceTransaction* _Nonnull transaction,
                                     ...
                                     const ARect* _Nonnull destination, enum ANativeWindowTransform transform)
                                     __INTRODUCED_IN(29);
