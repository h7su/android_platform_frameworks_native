...
impl DebugStoreEvent {
    /// Constructs a new `DebugStoreEvent`.
    ///
...
impl fmt::Display for DebugStoreEvent {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "ID:{},T:{}", self.id, self.timestamp.elapsed().as_millis())?;
