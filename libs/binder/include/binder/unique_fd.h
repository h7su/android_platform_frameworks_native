...
// TODO(b/302723053): remove
namespace android {
inline base::borrowed_fd borrowedToBase(base::borrowed_fd fd) {
    return fd;
}
} // namespace android
...
#include <android-base/unique_fd.h>
namespace android {
inline base::borrowed_fd borrowedToBase(binder::borrowed_fd fd) {
    return base::borrowed_fd(fd.get());
}
} // namespace android
#else
namespace android {
inline binder::borrowed_fd borrowedToBase(binder::borrowed_fd fd) {
    return fd;
}
} // namespace android
#endif
