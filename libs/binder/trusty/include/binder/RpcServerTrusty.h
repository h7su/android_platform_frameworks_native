...
private:
    ...
    friend ::RpcServerTrustyRust* ::RpcServerTrustyRust_newPerSession(
            ::AIBinder* (*)(const void*, size_t, void*), void*);
    ...
    friend int ::RpcServerTrustyRust_handleConnect(::RpcServerTrustyRust*, handle_t, const uuid*,
                                                   void**);
    friend int ::RpcServerTrustyRust_handleMessage(void*);
    friend void ::RpcServerTrustyRust_handleDisconnect(void*);
