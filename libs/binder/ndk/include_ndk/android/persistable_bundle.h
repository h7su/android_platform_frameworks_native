 ...
 * value and a non-existant key.
 */
const int32_t APERSISTABLEBUNDLE_KEY_NOT_FOUND = -1;
 ...
 */
const int32_t APERSISTABLEBUNDLE_ALLOCATOR_FAILED = -2;
 ...
 *         -2 if the provided allocator fails and returns false
 */
 ...
 *         -1 if the key was not found
 *         -2 if the user supplied APersistableBundle_stringAllocator returns
 *         false
 */
